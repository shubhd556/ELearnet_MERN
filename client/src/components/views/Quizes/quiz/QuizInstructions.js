...
const QuizInstructions = () => (
    <Fragment>
        ...
        <div className="instructions container">
            <h1>Instruction to solve the quiz</h1>
            ...
            <ul className="browser-default" id="main-list">
                ...
                <li>
                    ...
                    will remove one wrong answer leaving two wrong answers and one correct answer. You can use as many hints as possible on single question.
                    </li>
